...
SRC =	src/main.c \
		...
		src/rendering/cgtutor.c src/rendering/minimap.c src/vec2/perpendicular_vec2.c src/vec2/s_multiplication.c \
		...
		src/parser/map_mem_alloc.c src/parser/check_error_identifiers.c	src/parser/check_error_walls_row.c \
		src/parser/check_error_walls_column.c src/parser/map_error_handling_1.c src/parser/get_next_line.c \
		src/parser/utils.c src/parser/tex_handling.c src/parser/set_player_pos.c \
